...
const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets',
    price: 'PKR 3,500.00',
    // oldPrice: 'PKR 1,300.00',
    image: 'https://tkmtradingshop.com/cdn/shop/files/WhatsAppImage2024-11-02at11.17.28PM.jpg?v=1730615021',
  },
  {
    id: 'k5',
    name: 'Stainless Steel L-shape Kitchen Faucet',
    category: 'Kitchen Faucets',
    price: 'PKR 3,500.00',
    // oldPrice: 'PKR 1,300.00',
    image: 'https://tkmtradingshop.com/cdn/shop/files/WhatsAppImage2024-08-03at10.44.53AM.jpg?v=1722708095',
  }
];
...
export const KitchenMixers: React.FC<Props> = ({ onNavigate }) => {
  return (
    <section id="kitchen-faucets">
      ...
      {/* Banner */}
      <div 
        className="w-full h-[300px] md:h-[450px] mb-8 overflow-hidden relative cursor-pointer group"
